...
public class QuartzFiredTriggerEntityTypeConfiguration(string? prefix, string? schema, QuartzColumnTypes types)
    : IEntityTypeConfiguration<QuartzFiredTrigger>
{
    public void Configure(EntityTypeBuilder<QuartzFiredTrigger> builder)
    {
        ...
        builder.Property(x => x.EntryId).HasColumnName("entry_id").HasColumnType(types.Text).IsRequired();
        ...
        builder.Property(x => x.FiredTime).HasColumnName("fired_time").HasColumnType(types.BigInt).IsRequired();
        builder.Property(x => x.ScheduledTime).HasColumnName("sched_time").HasColumnType(types.BigInt).IsRequired();
        builder.Property(x => x.Priority).HasColumnName("priority").HasColumnType(types.Int).IsRequired();
        builder.Property(x => x.State).HasColumnName("state").HasColumnType(types.Text).IsRequired();
        builder.Property(x => x.JobName).HasColumnName("job_name").HasColumnType(types.Text);
        builder.Property(x => x.JobGroup).HasColumnName("job_group").HasColumnType(types.Text);
        builder.Property(x => x.IsNonConcurrent).HasColumnName("is_nonconcurrent").HasColumnType(types.Bool).IsRequired();
        builder.Property(x => x.RequestsRecovery).HasColumnName("requests_recovery").HasColumnType(types.Bool);
        ...
        builder.HasIndex(x => new { x.SchedulerName, x.TriggerName, x.TriggerGroup }).HasDatabaseName($"idx_{prefix}ft_trig_nm_gp");
